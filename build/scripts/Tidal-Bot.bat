...
set CLASSPATH=%APP_HOME%\lib\Tidal-Bot.jar;%APP_HOME%\lib\commons-io-2.5.jar;%APP_HOME%\lib\commons-lang3-3.5.jar;%APP_HOME%\lib\emoji-java-4.0.0.jar;%APP_HOME%\lib\gson-2.6.2.jar;%APP_HOME%\lib\guava-21.0.jar;%APP_HOME%\lib\http-request-6.0.jar;%APP_HOME%\lib\log4j-1.2.17.jar;%APP_HOME%\lib\slf4j-api-1.7.25.jar;%APP_HOME%\lib\slf4j-log4j12-1.7.0.jar;%APP_HOME%\lib\JDA-4.BETA.0_32.jar;%APP_HOME%\lib\lavaplayer-1.3.21.jar;%APP_HOME%\lib\log4j-api-2.11.0.jar;%APP_HOME%\lib\log4j-core-2.11.0.jar;%APP_HOME%\lib\logback-classic-1.1.8.jar;%APP_HOME%\lib\jsr305-3.0.2.jar;%APP_HOME%\lib\annotations-16.0.1.jar;%APP_HOME%\lib\slf4j-api-1.7.25.jar;%APP_HOME%\lib\nv-websocket-client-2.5.jar;%APP_HOME%\lib\okhttp-3.13.0.jar;%APP_HOME%\lib\opus-java-1.0.4.pom;%APP_HOME%\lib\commons-collections4-4.1.jar;%APP_HOME%\lib\trove4j-3.0.3.jar;%APP_HOME%\lib\jackson-databind-2.9.8.jar;%APP_HOME%\lib\lava-common-1.1.0.jar;%APP_HOME%\lib\lavaplayer-natives-1.3.13.jar;%APP_HOME%\lib\httpclient-4.5.6.jar;%APP_HOME%\lib\commons-io-2.6.jar;%APP_HOME%\lib\jackson-core-2.9.8.jar;%APP_HOME%\lib\jsoup-1.11.3.jar;%APP_HOME%\lib\base64-2.3.9.jar;%APP_HOME%\lib\logback-core-1.1.8.jar;%APP_HOME%\lib\okio-1.17.2.jar;%APP_HOME%\lib\opus-java-api-1.0.4.jar;%APP_HOME%\lib\opus-java-natives-1.0.4.jar;%APP_HOME%\lib\jackson-annotations-2.9.0.jar;%APP_HOME%\lib\httpcore-4.4.10.jar;%APP_HOME%\lib\commons-logging-1.2.jar;%APP_HOME%\lib\commons-codec-1.10.jar;%APP_HOME%\lib\jna-4.4.0.jar
